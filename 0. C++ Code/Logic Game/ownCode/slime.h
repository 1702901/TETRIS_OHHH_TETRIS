...
public:
	Slime() { m_representacionTablero.setY(COLUMNESATAULER - 1); m_representacionTablero.setX(FILESTAULER - 1); };
	void inicialitza() { m_representacionTablero.setY(COLUMNESATAULER - 1); m_representacionTablero.setX(FILESTAULER - 1); }
